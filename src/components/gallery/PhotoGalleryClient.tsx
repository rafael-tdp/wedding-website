          ...
          {isSelectionMode && (
            <div className="flex gap-2 w-full sm:w-auto flex-wrap">
              <button
                ...
                className="flex-1 sm:flex-none px-2 sm:px-3 py-2 bg-gray-100 text-gray-700 hover:bg-gray-200 rounded text-xs sm:text-sm transition-colors"
              >
                {selectedPhotos.size === photos.length ? "Dés." : "Sel."} tout
              </button>
              ...
              {selectedPhotos.size > 0 && (
                <>
                  ...
                  <button
                    ...
                    className="flex-1 sm:flex-none px-3 py-2 bg-gray-100 text-gray-700 hover:bg-gray-200 rounded text-xs sm:text-sm transition-colors"
                  >
                    Annuler
                  </button>
                </>
